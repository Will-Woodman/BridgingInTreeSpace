...
public class ChibSampler {
    ...
    public static void parseCommandLine(String[] args) throws AlgorithmException {
        ...
        TreeAsSplits x0 = new TreeAsSplits(initialTree);//calculate the numerator by summing up acceptance rates for Y^* posterior samples
        ...
        while (i<n) {
            ...
            //choice of partial bridge proposals
            //highly recommended to use "pbg", the partial bridge proposal with geometrically distributed lengths:
...
for(int j=0 ; j<numProp ; j++){
 ...
 out.close();  
    ...
    //main class to define the parameters to use in the sampler: can loop through different runs of the sampler from the command line
    public static void main(String[] args) throws AlgorithmException {
       ...
       args = new String[18];
        ...
        args[4] = "1260"; // Seed
        args[5] = "-n";
        args[6] = "1500000"; // Num interations - before thin
        args[7] = "-t";
        args[8] = "100"; // thin
        args[9] = "-b";
        ...
        args[13] = "-pbg";
        args[14] = "0.02";//partial bridge proposals
        args[15] = "-numProps";
        args[16] = "300000"; //number of independence proposals to simulate directly for each data point
