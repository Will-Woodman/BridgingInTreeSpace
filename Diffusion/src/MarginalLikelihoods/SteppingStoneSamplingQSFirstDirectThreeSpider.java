...
public class SteppingStoneSamplingQSFirstDirectThreeSpider {
...
*/
       String TreeFileName= "/home/c1032934/Documents/Netbeans/TopInf20240503/MarginalLikelihoods/4TaxaOhne/x";
       for(int j=0;j<7;j++){
        args = new String[15];
        args[0] = "/home/c1032934/Documents/Netbeans/TopInf20240503/MarginalLikelihoods/4TaxaOhne/x"+j+".txt";
        args[1] = "/home/c1032934/Documents/Netbeans/TopInf20240503/MarginalLikelihoods/4TaxaOhne/x0.txt";
        args[2] = "0.5"; // Initial squ root t_0
        args[3] = "20"; // Num steps
        args[4] = "1802"; // Seed
        args[5] = "-n";
        args[6] = "2000"; // Num interations - before thin
        args[7] = "-t";
        args[8] = "20"; // thin
        args[9] = "-b";
        ...
        String outFilename="/data/ww24/MarginalLikelihoods/4TaxaOhne/StepStone/x"+j+"/StepStone";
        for(int i=0; i<100;i++){
          args[4] = Integer.toString(24*i*j); 
