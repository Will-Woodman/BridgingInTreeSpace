...
public class SteppingStoneSamplingQSFirstDirectYeast {
    ...
    args = new String[15];
        ...
        args[4] = "1802"; // Seed
        args[5] = "-n";
        args[6] = "150"; // Num interations - before thin
        args[7] = "-t";
        args[8] = "20"; // thin
        args[9] = "-b";
        ...
        args[13] = "-pbg";
        args[14] = "0.01";//geometric length bridge prop
        ...
        args2[1] = "10000";//number of Proposals to run
        ...
        for(int i=0; i<5;i++){
          ...
          args2[0] = "/Users/will/Documents/Will PhD/Netbeans Projects/TopInf/MarginalLikelihoods/FixedDispMultPoints/4Taxa/StepStone/Test"+i+"r0.txt";
          args[12] = "/Users/will/Documents/Will PhD/Netbeans Projects/TopInf/MarginalLikelihoods/FixedDispMultPoints/4Taxa/StepStone/Test"+i+"r";
...
*/
        ...
        args[1] = "/home/c1032934/Documents/Netbeans/TopInf20240503/ExperimentalData/EightYeast/yeast_new_ints_MCMCOutv2_splitModes_Tree.txt";
        args[2] = "0.13"; // Initial squ root t_0
        args[3] = "50"; // Num steps
        args[4] = "1802"; // Seed
        args[5] = "-n";
        args[6] = "10000"; // Num interations - before thin
        args[7] = "-t";
        args[8] = "20"; // thin
        args[9] = "-b";
        args[10] = "10000";//burn-in
        args[11] = "-o";
        args[12] = "/data/ww24/ExperimentalData/EightYeast/yeast_new_ints_MCMCOutv2_splitModes_Tree_StepStone";
        args[13] = "-pbg";
        args[14] = "0.05";//geometric length bridge prop
        
        //args for directly sampling from the proposal distribution
        String[] args2 = new String[7];
        args2[0] = "/data/ww24/ExperimentalData/EightYeast/yeast_new_ints_MCMCOutv2_splitModes_Tree_StepStone0.txt";//File to output the information about the proposals
        args2[1] = "50000";//number of Proposals to run
        args2[2] = args[1]; //File containing the source tree
        args2[3] = args[0]; // File containing the data set
        args2[4] = args[3]; // number of steps
        args2[5] = args[2]; // Square root dispersion
