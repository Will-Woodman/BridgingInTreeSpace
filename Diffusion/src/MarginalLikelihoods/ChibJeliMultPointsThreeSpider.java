...
*/
public class ChibJeliMultPointsThreeSpider {
...
*/
    ...
    args = new String[18];
        ...
        args[4] = "1260"; // Seed
        args[5] = "-n";
        args[6] = "40000"; // Num interations - before thin
        args[7] = "-t";
        args[8] = "20"; // thin
        args[9] = "-b";
        args[10] = "1000";
        args[11] = "-o";
        args[12] = "/Users/will/Documents/Will PhD/Netbeans Projects/TopInf/MarginalLikelihoods/10Taxa/PostOutTest.txt";
        args[13] = "-pbg";
        args[14] = "0.01";
        args[15] = "-numProps";
        args[16] = "10000"; //number of proposals for the denominator
        args[17] = "/Users/will/Documents/Will PhD/Netbeans Projects/TopInf/MarginalLikelihoods/5Taxa/PropData.txt"; //file to put the proposal data in
         String outFilename="/data/ww24/MarginalLikelihoods/4TaxaOhne/x"+j;
        for(int i=0; i<1;i++){
          args[4] = Integer.toString(174*j*i^3);  
          args[12] = outFilename+"PostOut"+i+".txt";
          args[17] = outFilename+"PropData"+i+".txt";;
          parseCommandLine(args);
        }
    }
    }
