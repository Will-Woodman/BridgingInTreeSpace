 ...
 * @author will
 */
public class ChibJeliEstimateMultPoints3Spider {
...
String firstFileName = "/data/ww24/MarginalLikelihoods/4TaxaOhne/x"+0+"PropData"+0+".txt";
        ...
        String OutFileName = "/data/ww24/MarginalLikelihoods/4TaxaOhne/x"+i+"results_Chib.txt";
        ...
        int propYstars=200;//estimate the log marginal likelihood at every propYstars-th bridge in the posterior
