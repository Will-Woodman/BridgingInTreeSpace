 ...
 * directly
 */
public class StepStoneEstimateFirstDirectMultPoints1 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String firstFileName = args[0]+0+"r"+0+".txt";
        ...
        String PosteriorFileName=args[0]+k+"r";
        //calculate and print the estimate
        double theEst = overallEst(PosteriorFileName,n, numOfFiles);
        out.println(theEst);
        }
        out.close();
    }
    ...
    /*
    Calculate the stepping stone estimate of marginal likelihood after runnin the stepping stone sampler
