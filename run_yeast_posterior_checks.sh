#!/bin/bash
source_tree_filename="./YeastData/yeast_new_ints_MCMCOutput_ModeTree.txt" # source tree filename
output_filename="./YeastData/yeast_new_ints_forward_sim_trees.txt" # data filename
distance_filename="./YeastData/yeast_new_ints_forward_sim_dists.txt" # data filename
