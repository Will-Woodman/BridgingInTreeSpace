...
public class RandomWalkSimulatorGGF {
    ...
    /*
    Class based on RandomWalkSimulator that uses GGF at each step.
    NB: not all classes in RandomWalkSimulator have been replicated here
    */
...
//            theTree.addWithCheck(q, Math.abs(l[ind]));
 ...
 /*
 Use the GGFRW class rather than this main class to simulate a random source tree as well as points under
 the GGF RW model
 */
