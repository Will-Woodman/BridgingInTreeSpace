 ...
 * Adapted from 2011 version in PhiPCA.
 */
...
//        theViewer.setOpaque(true); //content panes must be opaque???
    ...
    public static void main(String[] args) throws treebase.AlgorithmException, java.io.IOException {
        ...
        /* Get newick strings */
        File theFile = new File("/Users/will/Documents/Will PhD/Netbeans Projects/TopInf/PGR Conference Presentation/TreeSpacePaths/Path1.txt");
