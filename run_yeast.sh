...
frechet_params_filename="./YeastData/yeast_new_ints_FM_double_its.txt"
frechet_distances_filename="./YeastData/yeast_new_ints_FM_distances_double_its.txt"
output_filename="./YeastData/yeast_new_ints_MCMCOutput_double_its.txt"
topologies_filename="./YeastData/yeast_new_ints_MCMCOutput_tops_double_its.txt"
modal_top_edges_filename="./YeastData/yeast_new_ints_MCMCOutput_edges_double_its.txt"
